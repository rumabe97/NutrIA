...
- 2026-09-07 — Reuse is rotated per user and per plan version, and a user is never served last fortnight's dishes again; the prompt is told what they had and asked for a counted spread. Amends [`0006`](./0006-reuse-before-generating.md): the cost claim bends for returning users until the library is large. (who decided: owner, by report; agent, the mechanism)
