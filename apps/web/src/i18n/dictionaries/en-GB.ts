...
export const enGB: Dictionary = {
  ...
  progress: {
    adherenceLabel: 'of the meals you marked, eaten',
    adherenceNone: 'You have not marked any meal of this fortnight yet.',
    ...
    fortnightTitle: 'Fortnight {version}',
    ...
    title: 'Your progress',
    toTargetGain: '{value} kg to go to your target',
    toTargetLoss: '{value} kg to lose to your target',
    toTargetReached: 'You are at your target weight',
    unavailable: 'We could not load your progress. Try again in a moment.',
    weightChangeFortnight: '{change} kg over the last fortnight',
    weightChangeSinceStart: '{change} kg since you started',
