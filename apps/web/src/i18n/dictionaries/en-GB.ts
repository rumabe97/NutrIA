...
export const enGB: Dictionary = {
  ...
  admin: {
    ...
    recipes: 'Recipes',
    registrationClosedHint: 'Nobody can create an account. Anyone who already has one still signs in, and anyone waiting is opened by you, here.',
    registrationOpen: 'Registration open',
    registrationOpenHint: 'Anyone can create an account, and they are in as soon as they confirm their address. Nothing for you to do.',
