...
export const esES = {
  ...
  profile: {
    ...
    premiumPerMonth: '{price} al mes. Puedes cancelarlo cuando quieras.',
    premiumPerYear: '{price} al año. Puedes cancelarlo cuando quieras.',
    premiumPitch:
    ...
    premiumSubscribe: 'Hacerme premium',
