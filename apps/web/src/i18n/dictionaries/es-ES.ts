...
export const esES = {
  ...
  onboarding: {
    ...
    fields: {
      ...
      country: 'País',
      countryHint: 'Código de dos letras.',
  ...
  progress: {
    adherenceLabel: 'de las comidas que marcaste, hechas',
    adherenceNone: 'Todavía no has marcado ninguna comida de esta quincena.',
    ...
    fortnightTitle: 'Quincena {version}',
    ...
    title: 'Tu progreso',
    toTargetGain: 'Te faltan {value} kg para tu objetivo',
    toTargetLoss: 'Te sobran {value} kg para tu objetivo',
    toTargetReached: 'Estás en tu peso objetivo',
    unavailable: 'No hemos podido cargar tu progreso. Prueba de nuevo en un momento.',
    weightChangeFortnight: '{change} kg en la última quincena',
    weightChangeSinceStart: '{change} kg desde que empezaste',
