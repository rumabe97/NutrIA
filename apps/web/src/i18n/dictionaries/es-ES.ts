...
export const esES = {
  ...
  admin: {
    ...
    recipes: 'Recetas',
    registrationClosedHint: 'Nadie puede crear una cuenta. Quien ya tiene una entra igual, y a quien esté esperando lo abres tú desde aquí.',
    registrationOpen: 'Registro abierto',
    registrationOpenHint: 'Cualquiera puede crear una cuenta y entra en cuanto confirma su correo. Tú no tienes que hacer nada.',
