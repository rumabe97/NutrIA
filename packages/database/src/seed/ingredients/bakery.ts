...
export const BAKERY: readonly IngredientSeed[] = [
  ...
  {
    allergens: [{ key: 'gluten' }, { key: 'sesame', presence: 'may_contain' }, { key: 'tree_nuts', presence: 'may_contain' }],
    carbs: 43.3,
    category: 'bakery',
    defaultUnit: 'slice',
    fat: 4.2,
  ...
  },
  {
    ...
    gramsPerUnit: 12,
    kcal: 334,
    name: 'Tostas de centeno',
    protein: 9.6,
    slug: 'tostas-de-centeno',
    source: 'usda'
  },
  {
  ...
  {
    allergens: [{ key: 'gluten' }, { key: 'milk', presence: 'may_contain' }, { key: 'sesame', presence: 'may_contain' }],
    carbs: 50.1,
    category: 'bakery',
    defaultUnit: 'unit',
    fat: 3.9,
  ...
  },
  {
    ...
    protein: 12.4,
    slug: 'pan-de-hamburguesa-integral',
    source: 'usda'
  },
  {
    allergens: [{ key: 'gluten' }],
    ...
    gramsPerUnit: 250,
    kcal: 250,
    name: 'Base de pizza fresca',
    protein: 8,
    slug: 'base-de-pizza-fresca'
  },
  // ── Enriched and sweet ────────────────────────────────────────────────
  {
  ...
  {
    allergens: [{ key: 'gluten' }, { key: 'milk' }, { key: 'eggs' }, { key: 'soy', presence: 'may_contain' }],
    carbs: 47.9,
    category: 'bakery',
    defaultUnit: 'unit',
    fat: 22.7,
  ...
  {
    allergens: [{ key: 'gluten' }, { key: 'eggs' }, { key: 'milk' }, { key: 'soy', presence: 'may_contain' }],
    carbs: 65.4,
    category: 'bakery',
    defaultUnit: 'unit',
    fat: 24.7,
  ...
  {
    allergens: [{ key: 'gluten' }, { key: 'eggs' }, { key: 'milk' }, { key: 'tree_nuts', presence: 'may_contain' }],
    carbs: 63.9,
    category: 'bakery',
    defaultUnit: 'unit',
    fat: 16.3,
  ...
  {
    allergens: [{ key: 'gluten' }, { key: 'milk' }, { key: 'eggs', presence: 'may_contain' }],
    carbs: 34,
    category: 'bakery',
    defaultUnit: 'slice',
    fat: 11,
