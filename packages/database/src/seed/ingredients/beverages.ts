...
export const BEVERAGES: readonly IngredientSeed[] = [
  ...
  { carbs: 3.7, category: 'beverages', defaultUnit: 'ml', fat: 0.2, fiber: 1.1, kcal: 19, name: 'Agua de coco', protein: 0.7, slug: 'agua-de-coco', source: 'usda' },
  { carbs: 10.4, category: 'beverages', defaultUnit: 'ml', fat: 0.2, kcal: 45, name: 'Zumo de naranja', protein: 0.7, slug: 'zumo-de-naranja', source: 'usda' },
  { carbs: 11.3, category: 'beverages', defaultUnit: 'ml', fat: 0.1, kcal: 46, name: 'Zumo de manzana', protein: 0.1, slug: 'zumo-de-manzana', source: 'usda' },
  { carbs: 12.9, category: 'beverages', defaultUnit: 'ml', fat: 0.1, kcal: 53, name: 'Zumo de piña', protein: 0.4, slug: 'zumo-de-pina', source: 'usda' },
  { carbs: 12.2, category: 'beverages', defaultUnit: 'ml', fat: 0.1, kcal: 46, name: 'Zumo de arándanos', protein: 0.4, slug: 'zumo-de-arandanos', source: 'usda' },
  { carbs: 11.5, category: 'beverages', defaultUnit: 'ml', fat: 0.1, kcal: 48, name: 'Zumo multifrutas', protein: 0.3, slug: 'zumo-multifrutas' },
  { carbs: 3.5, category: 'beverages', defaultUnit: 'ml', fat: 0.3, fiber: 0.4, kcal: 17, name: 'Zumo de tomate', protein: 0.8, slug: 'zumo-de-tomate', source: 'usda' },
  ...
  { carbs: 9.2, category: 'beverages', defaultUnit: 'ml', fat: 1, kcal: 47, name: 'Bebida de arroz', protein: 0.3, slug: 'bebida-de-arroz', source: 'usda' },
  ...
  { carbs: 14.8, category: 'beverages', defaultUnit: 'ml', fat: 0.1, kcal: 60, name: 'Zumo de uva', protein: 0.4, slug: 'zumo-de-uva', source: 'usda' },
  { carbs: 12, category: 'beverages', defaultUnit: 'ml', fat: 0.1, kcal: 50, name: 'Zumo de melocotón', protein: 0.5, slug: 'zumo-de-melocoton' },
  { carbs: 13.1, category: 'beverages', defaultUnit: 'ml', fat: 0.3, kcal: 54, name: 'Zumo de granada', protein: 0.1, slug: 'zumo-de-granada', source: 'usda' },
