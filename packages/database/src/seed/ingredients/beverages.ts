...
export const BEVERAGES: readonly IngredientSeed[] = [
  ...
  { carbs: 0.3, category: 'beverages', defaultUnit: 'ml', fat: 0, kcal: 1, name: 'Té negro', protein: 0, slug: 'te-negro', source: 'usda' },
  {
    carbs: 0.2,
    category: 'beverages',
    defaultUnit: 'ml',
  ...
  },
  {
    ...
    fat: 1,
    kcal: 60,
    name: 'Bebida de proteínas',
    protein: 10,
    slug: 'bebida-de-proteinas'
  },
  ...
  { carbs: 8.8, category: 'beverages', defaultUnit: 'ml', fat: 0, kcal: 34, name: 'Tónica', protein: 0, slug: 'tonica', source: 'usda' },
  ...
  { carbs: 2.7, category: 'beverages', defaultUnit: 'ml', fat: 1, kcal: 20, name: 'Bebida de coco', protein: 0.2, slug: 'bebida-de-coco' },
  {
    ...
    fat: 1.6,
    kcal: 29,
    name: 'Bebida de avellanas',
    protein: 0.4,
    slug: 'bebida-de-avellanas'
  },
  {
    allergens: [{ key: 'tree_nuts' }],
    carbs: 1,
    ...
    fat: 2,
    kcal: 25,
    name: 'Bebida de anacardos',
    protein: 0.5,
    slug: 'bebida-de-anacardos'
  },
  {
    allergens: [
  ...
  // ── Second pass ───────────────────────────────────────────────────────
  {
    ...
    fat: 0,
    kcal: 1,
    name: 'Infusión de menta poleo',
    protein: 0,
    slug: 'infusion-de-menta-poleo'
  },
  {
    carbs: 14.8,
    category: 'beverages',
  ...
  },
  {
    ...
    fat: 1,
    kcal: 55,
    name: 'Bebida de proteínas vegetal',
    protein: 8,
    slug: 'bebida-de-proteinas-vegetal'
  }
];
